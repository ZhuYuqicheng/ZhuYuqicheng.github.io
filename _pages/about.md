...
I'm Yuqicheng Zhu. As a Ph.D. student affiliated with the [Bosch Center for Artificial Intelligence (BCAI)](https://www.bosch-ai.com/) and the [International Max Planck Research School for Intelligent Systems (IMPRS-IS)](https://imprs.is.mpg.de/), and currently a visiting scholar at the University of Oxford. My research focuses on trustworthy AI, particularly uncertainty quantification with statistical guarantees and neuro-symbolic systems that combine the structured reasoning of symbolic AI with the learning capabilities of modern neural methods.
